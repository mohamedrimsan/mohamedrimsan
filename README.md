...
<h3 align="center">
QA & Security Engineer Trainee | Cybersecurity | Application Security | Cloud Security | GRC
</h3>

<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=2500&pause=800&color=00F7FF&center=true&vCenter=true&width=900&lines=QA+%26+Security+Engineer+Trainee;Application+Security+%26+API+Security+Testing;Vulnerability+Management+%26+Cloud+Security;Governance+Risk+%26+Compliance+(GRC);Building+Secure+and+High-Quality+Digital+Solutions" />
</p>
...
I am a QA & Security Engineer Trainee and BSc (Hons) Information Technology undergraduate with practical experience in cybersecurity, software quality assurance, vulnerability management, cloud security validation, and governance, risk & compliance (GRC).

My work includes web application security assessments, API testing, vulnerability analysis, deployment verification, quality assurance testing, and compliance reviews for enterprise-grade digital platforms.

I am passionate about identifying security weaknesses, improving software quality, and helping organizations build secure, reliable, and resilient systems.
...
Currently contributing to enterprise-grade digital platforms through:

* Web Application Security Assessments
* API Security & Functional Testing
* Vulnerability Assessment & Remediation
* AWS Deployment Validation
* Quality Assurance & UAT Testing
* Defect Management & Jira Administration
...
✅ Performed Vulnerability Analysis & Remediation

✅ Executed API Security & Functional Testing

✅ Supported AWS Deployment Verification

✅ Managed Defects & Enhancements Through Jira

✅ Contributed to Governance & Compliance Reviews

✅ Supported Production Readiness & UAT Activities

✅ Developed Security & Compliance Documentation
...
Building Secure Systems • Improving Software Quality • Managing Risk
